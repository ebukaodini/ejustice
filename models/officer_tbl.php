...
class OfficerModel
{
   ...
   public function create($inputs){
      ...
      $query = "INSERT INTO officer_tbl ({$fields}) 
      VALUE ({$bindValues})";
   ...
   public function read($fields){
      ...
      $query = "SELECT {$fields} FROM officer_tbl {$queryConditions}";
   ...
   public function update($updates){
      ...
      $query = "UPDATE officer_tbl SET {$sets} {$queryConditions}";
   ...
   public function delete(){
      ...
      $query = "DELETE FROM officer_tbl {$queryConditions}";
